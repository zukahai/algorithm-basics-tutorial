...
### Bài 7: Tổng bé hơn hoặc bằng S

Nhập vào mảng số nguyên a[] gồm n phần tử đã sắp xếp tăng dần và một số nguyên S. <br>
Đếm xem có bao nhiêu cặp số (a[i], a[j]) sao cho a[i] + a[j] ≤ S.
...
| Input | Output |
|-------|--------|
| 5<br> 1 2 2 3 4 5<br> 3 | 2 |

**Giải thích**: Có 3 cặp số: (a[0], a[1]), (a[0], a[2])

#### Ví dụ 2

| Input | Output |
|-------|--------|
| 5<br> 1 2 3 4 5<br> 5 | 5 |

**Giải thích**: Có 4 cặp số: (a[0], a[1]), (a[0], a[2]), (a[0], a[3]), (a[1], a[2]), (a[1], a[3])
...
Tìm kiếm vị trí cuối cùng của S - a[i] trong mảng a[]
