...
void gen(int iTest, int testnum, string target_file)
{
    ...
    string s = random_string(n, "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789");


    if (random(1, 3) == 1)
    {
        s = random_string(n, "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789  ");
    }
    if (random(1, 4) == 1)
    {
        s = random_string(n, "abcdefghijklmnopqrstuvwxyz0123456789");
    }
